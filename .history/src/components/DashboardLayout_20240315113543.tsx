  ...
  return (
    <div
      className={`h-full grid ${
        open ? "grid-cols-[240px_1fr]" : "grid-cols-[68px_1fr]"
      } max-md:grid-cols-[60px_1fr]   duration-500 grid-rows-[60px_1fr] p `}
    >
    ...
    <Card className="col-[1/2] row-[1/3] bg-inherit px-4 mb-3  rounded-none">
      ...
      <main className="bg-inherit col-[2/3] row-[2/3] p-3 overflow-auto ">
        {children}
        </main>
    </div> 
  )
