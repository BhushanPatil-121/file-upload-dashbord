...
export function SignUpForm() {
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    ...
    if (response.ok) {
      ...
      toast.update(id, {render: "User email already linked", type: "error", isLoading: false});
    } else {
      toast.update(id, {render: "Account created successfully", type: "error", isLoading: false});
