...
const DashboardLayout: FC<CommanLayoutProps> = ({ children }) => {
  ...
  return (
    ...
    >
      <Card className=" bg-gray-200 dark:bg-slate-700  col-[1/2] row-[1/3]  px-4   rounded-none">
      ...
      <Card className="bg-inherit col-[2/3] row-[2/3]  overflow-auto rounded-none mt-2 ">
        {children}
      </Card>
    </div>
  );
