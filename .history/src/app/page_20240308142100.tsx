      ...
      <div className="flex flex-col items-center justify-center min-h-screen min-w-full">
        {file ? (
            ...
            <CardContent>
              <form>
                <div className="grid w-full items-center gap-4">
                  ...
                  <div className="flex flex-col space-y-3">
                    <div className="flex flex-row space-x-5 ">
                      <div className="flex flex-col space-y-3 w-[180px]">
                        <Label htmlFor="category">File Category
                        { !category &&
                        <span className="px-2  text-red-500 font-semibold">
                          *required
                        </span>
                  ...
                  <div className="flex flex-col space-y-3">
                    <Label htmlFor="name">Select Date
                    { !date &&
                        <span className="px-2  text-red-500 font-semibold">
                          *required
                        </span>
          ...
          <div className="flex flex-col items-center justify-center min-h-screen min-w-full gap-10">
            <h2 className="text-center text-4xl font-extrabold relative after:absolute after:-bottom-5 after:h-1 after:w-1/2 after:bg-green-400 after:left-0 after:right-0 after:mx-auto after:rounded-full">Try using our templates</h2>
