      ...
      <div className="flex flex-col items-center justify-center min-h-screen min-w-full">
        {file ? (
                ...
                <div className="grid w-full items-center gap-4">
                  <div className="flex flex-col space-y-3">
                    <Label htmlFor="fileName" className="flex flex-row">
                      File Name
                      {!fileName && (
                        <span className="px-2  text-red-500 font-semibold">
                          *required
                        </span>
                      )}
                    </Label>
          ...
          <div className="flex flex-col items-center justify-center min-h-screen min-w-full gap-10">
            <h2 className="text-center text-4xl font-extrabold relative after:absolute after:-bottom-5 after:h-1 after:w-1/2 after:bg-green-400 after:left-0 after:right-0 after:mx-auto after:rounded-full">
              Effortless PDF Upload
            </h2>

            <h2 className="text-4xl flex flex-col items-center justify-center text-center font-normal  p-0.5 leading-7">
