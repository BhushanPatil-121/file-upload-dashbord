    ...
    >
      <Card className="flex flex-col items-center justify-center min-h-screen min-w-full">
        {file ? (
          ...
          <Card className="flex flex-col items-center justify-evenly border-hidden gap-5 shadow-none	">
            <CardTitle className="flex flex-col items-center justify-center text-center font-black p-10">
