...
export default function Layout({
  ...
  return (
    <div className={`h-screen grid grid-cols-[300px_1fr] grid-rows-[60px_1fr]  `}>
      <header className="bg-purple-500 col-[2/3] row-[1/2]">hu</header>
      <section className="bg-red-500 col-[1/2] row-[1/3]">wd</section>
      <main className="bg-green-500 col-[2/3] row-[2/3]">dw</main>
      {/* {children} */}
    </div>
