  ...
  return (
    <Card className="h-full rounded-none ">
      <div className=" flex flex-col lg:flex-row p-3 gap-2 ">
        <Card className="dark:bg-slate-800 shadow-xl w-full lg:w-2/5 p-4 sm:p-6 lg:p-8 bg-inherit   ">
        ...
        <Card className="w-full shadow-xl lg:w-3/5 p-8 bg-inherit lg:ml-4 ">
