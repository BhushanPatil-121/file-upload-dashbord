  ...
  return (
    <Card className="h-full rounded-none ">
      <div className=" block md:flex p-3">
        <Card className="w-full md:w-2/5 p-4 sm:p-6 lg:p-8 bg-inherit   ">
          <div className="flex justify-between">
            <span className="text-xl font-semibold block">Your Profile</span>
            <Button>
            <a
              href="#"
              className="-mt-2 text-md font-bold text-inherit  rounded-full px-5 py-2 hover:bg-gray-300"
            >
              Edit
            </a>
            </Button>
        ...
        <Card className="w-full md:w-3/5 p-8 bg-inherit lg:ml-4 ">
