...
export default function Layout({
  ...
  return (
    <section className="flex ">
      ...
      <div className="flex flex-col overflow-hidden bg-[#f2edf3]  text-xl text-gray-900 font-semibold  overflow-hidden">
        <NavBar />
        <div className="bg-[#ca49f5]  text-xl text-gray-900 font-semibold w-screen p-3 ">
          {children}
        </div>
      </div>
    </section>
