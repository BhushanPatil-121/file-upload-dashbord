...
export default function Layout({
  ...
  return (
    <section className="flex ">
      ...
      <div className="bg-[#f2edf3]  text-xl text-gray-900 font-semibold w-screen ">
        <NavBar />
        <div className="bg-[#f2edf3]  text-xl text-gray-900 font-semibold w-screen p-3 overflow-y-scroll">{children}</div>
      </div>
    </section>
  );
}
