...
export default function Layout({
  ...
  return (
    <div
      ...
      } max-md:grid-cols-[64px_1fr]   duration-500 grid-rows-[60px_1fr]  `}
    >
      <section className="col-[1/2] row-[1/3] text-gray-900 px-4 fixed">
        <div className="py-3 flex justify-end">
          <HiMenuAlt3
            size={26}
            className="cursor-pointer max-md:invisible "
      ...
      <header className=" col-[2/3] row-[1/2] fixed">
        <NavBar/>
      </header>
      <main className="bg-[#f2edf3] col-[2/3] row-[2/3] p-3">{children}</main>
    </div>
