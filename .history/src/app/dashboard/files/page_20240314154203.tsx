...
export default function PdfListPage() {
  ...
  return (
    <div className="flex flex-col items-center justify-between  min-w-full mt-14 ">
      {showEditPopUp && (
        <div className="absolute z-50  flex min-h-screen flex-col items-center justify-center  min-w-full  w-11/12 h-96  ">
            ...
            <div className=" mx-auto pt-4 px-0 flex flex-row justify-items-start gap-1 max-[1275px]:flex-col items-start ">
              <div className="flex flex-row  max-sm:flex-col max-sm:min-w-full">
                ...
                <div className="rounded-xl min-w-60 max-h-[40px] mb-2 flex flex-row items-center gap-1">
                  ...
                  {clearFilter && categoryFilterValue != "All Files" && (
                    <FilterAltOffIcon
              ...
              <div className="mb-2 flex flex-row gap-4 items-center justify-center  max-sm:flex-col">
                <Label htmlFor="name">Date Filter</Label>
                <div className="max-[560px]:flex-row flex gap-4 ">
                  <div className="min-[640px]:flex-row flex gap-4 flex-col">
                    <Popover>
                      <PopoverTrigger asChild>
                        <Button
                          variant={"outline"}
                ...
                <Table stickyHeader>
                  <TableHead>
                    <TableRow>
                      ...
                      {["Category", "Size", "Upload Date", "View"].map(
                        (item, index) => (
                          <TableCell
                            key={index}
