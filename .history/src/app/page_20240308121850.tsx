      ...
      <div className="flex flex-col items-center justify-center min-h-screen min-w-full">
        {file ? (
          ...
          <div className="flex flex-col items-center justify-center min-h-screen min-w-full gap-10">
            ...
            <div className="bg-gray-50 text-center px-4 rounded w-2/3 flex flex-col items-center justify-center cursor-pointer  border-gray-400 border-none mx-auto font-[sans-serif]">
              <div className="py-6">
                <svg
