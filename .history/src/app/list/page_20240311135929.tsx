      ...
      <div className="  w-11/12 h-96 ">
        <div className="container mx-auto py-4 px-0 ">
          <div className="w-inherit">
            <div className="container w-full mx-auto pt-4 px-0 flex flex-row justify-items-center gap-2 max-[1010px]:flex-col ">
              <div className="rounded-xl border-[1px] min-w-[350px] mb-2 max-h-[40px] px-3 flex  justify-center items-center">
                <SearchIcon />
                <InputBase
              ...
              <div className="rounded-xl min-w-80 max-h-[40px] mb-2 flex flex-row items-center gap-1">
                ...
                </div>
                {
                    clearFilter && <FilterAltOffIcon sx={{cursor:"pointer"}} onClick={()=>{
                        ...
                        setCategoryFilterValue("Select Category")
