      ...
      <div className="  w-11/12 h-96 ">
        <div className="container mx-auto py-4 px-0 ">
          <div className="w-inherit ">
            <div className=" mx-auto pt-4 px-0 flex flex-row justify-items-start gap-1 max-[1275px]:flex-col items-end ">
              <div className="flex flex-row max-[1215px]:w-full ">
                <div className="rounded-xl border-[1px] min-w-[350px] mb-2 max-h-[40px]  flex  justify-start items-center max-[1275px]:flex-col items-end">
                ...
                <Table stickyHeader>
                  <TableHead>
                    <TableRow>
                      ...
                      {
                        ["Category","Size","Size","Edit","Action"].map((item,index) =>(
                          <TableCell
                            key={index}
                        ...
                        .map((pdf, index1) => {
                          return (
                            <TableRow key={index1} sx={  theme === "light"  ? styles.lightHover : styles.darkHover }  >
                              <TableCell sx={ theme === "light" ? styles.lightHover : styles.darkHover }
                              >
                                {pdf.fileName}
                              </TableCell>
                              <TableCell
                              ...
                              >
                                <Button
                                  ...
                                  onClick={() => downloadPDF(pdf.pdf, pdf.fileName)}
                                >
