      ...
      <div className="  w-11/12 h-96 ">
        <div className="container mx-auto py-4 px-0 ">
          <div className="w-inherit">
            <div className="container w-full mx-auto pt-4 px-0 flex flex-row justify-items-start gap-2 max-[1010px]:flex-col ">
              ...
              <div className="min-w-60 mb-2 flex flex-row gap-4">
                <Popover>
                  <PopoverTrigger asChild>
                    <Button
