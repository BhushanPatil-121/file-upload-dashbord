      ...
      <div className="  w-11/12 h-96 ">
        <div className="container mx-auto py-4 px-0 ">
          <div className="w-inherit">
            <div className="container w-full mx-auto py-4 px-0 flex flex-row justify-items-start gap-2 max-[1010px]:flex-col">
              <div className="rounded-xl border-[1px] min-w-80 mb-2  px-3 flex  justify-center items-center">
                <SearchIcon />
                <InputBase
                  sx={{ ml: 1, flex: 1, color: "inherit", max-height:"40px", }}
