...
export default function PdfListPage() {
  ...
  const [cateoryFilterValue, setCateoryFilterValue] = useState<string>("");
      ...
      <div className="  w-11/12 h-96 ">
        <div className="container mx-auto py-6 px-0 ">
          <div className="w-inherit">
            <div className="container w-full mx-auto py-6 px-0 flex flex-row justify-items-start gap-2 max-[1010px]:flex-col">
              <div className="rounded-xl border-[1px] min-w-80 mb-2  px-3 flex  justify-center items-center">
                <SearchIcon />
                <InputBase
              ...
              <div className="rounded-xl min-w-80 mb-2 flex flex-row py-1 items-center gap-1">
                <SwapVertIcon />
                ...
                {
                    clearFilter && <FilterAltOffIcon sx={{cursor:"pointer"}} onClick={()=>{
                        getByCategory("All Files")
                    }}/>
                }
              </div>
              <div className="min-w-80 mb-2 ">
                {/* <DateRangePicker /> */}
              </div>
            </div>
