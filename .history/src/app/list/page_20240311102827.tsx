...
const styles = {
    ...
    tableRow: { borderBottomWidth: "2px", borderColor: "inherit", bgcolor: "hsl(var(--background))", color: "inherit", fontWeight: "bold" },
...
export default function PdfListPage() {
    ...
    const [showMissingFieldError, setShowMissingFieldError] = useState<boolean>(false);
    ...
    const filterPdfList = (category: string, start: Date | null, end: Date | null, query: string) => {
        let filteredList = allPdfList;
        ...
        if (query.trim() !== "") {
            filteredList = filteredList.filter(file => file.fileName.toLowerCase().includes(query));
        }
    ...
    const handleSelectDateRange = (date: any) => {
        ...
        filterPdfList(fileCategory, date.selection.startDate, date.selection.endDate, searchQuery);
                    ...
                    <div className="flex flex-col items-center justify-center  h-full min-w-full bg-gray-900  bg-opacity-95 ">
                        <Card className="px-3 w-[350px] h-[450px]">
                                    ...
                                    <div className="grid w-full items-center gap-4">
                                        ...
                                        <div className="flex flex-col space-y-3">
                                            ...
                                            <Select
                                                ...
                                                onValueChange={(e) => setEditField({ ...editField, category: e })}
                                            >
                            ...
                            <CardFooter className="flex justify-end gap-3">
                                <Button variant={"outline"} onClick={() => setShowEditPopUp(false)}>
                                    Cancel
                                </Button>
                ...
                <div className="container mx-auto py-6">
                    <div className="w-full" >
                        ...
                        <div className="rounded-xl border-2 ">
                            <TableContainer className="max-h-[850px] min-h-[850px] text-inherit ">
                                <Table stickyHeader>
                                    <TableHead  >
                                        <TableRow >
                                            <TableCell sx={[styles.tableRow, styles.tableRowFirst, styles.th]} >
                                                File
                                            </TableCell>
                                            ...
                                            <TableCell sx={[styles.tableRow, styles.tableRowLast, styles.th]}>
                                                Download
                                            </TableCell>
                                        </TableRow>
                                    </TableHead>
                                    <TableBody>
                                        {
                                            pdfList.length > 0 ?
                                                pdfList.slice(page * rowperpage, page * rowperpage + rowperpage)
                                                    .map((pdf, index1) => {
                                                        return (
                                                            <TableRow key={index1} sx={theme === 'light' ? styles.lightHover : styles.darkHover}>
                                                                <TableCell sx={{ color: "inherit", borderColor: "inherit" }} >
                                                                    {pdf.fileName}
                                                                </TableCell>
                                                                <TableCell sx={{ color: "inherit", borderColor: "inherit" }}>
                                                                    {pdf.category}
                                                                ...
                                                                <TableCell sx={{ color: "inherit", borderColor: "inherit" }}>
                                                                    <EditNoteIcon sx={{ cursor: "pointer" }} onClick={() => handleEdit(pdf)} />
                                                                </TableCell>
                                                                <TableCell sx={{ color: "inherit", borderColor: "inherit" }}>
                                                                    <div className="gap-4 flex ">
                                                                        <RemoveRedEyeIcon sx={{ cursor: "pointer" }} onClick={() => handleDelete(pdf.id)} />
                                                                        <DeleteIcon sx={{ cursor: "pointer" }} onClick={() => handleDelete(pdf.id)} />
                                                                    </div>
                                                                </TableCell>
                                                            </TableRow>
                                                        )
                                                ...
                                                <TableRow >
                                                    <TableCell colSpan={6} sx={{ color: "inherit", borderColor: "inherit", textAlign: "center" }} >
                                                        No Record Found
                                                    </TableCell>
                                                </TableRow>
                                        }
                            ...
                            <TablePagination
                                sx={{ borderTopWidth: "2px", borderColor: "inherit", color: "inherit", borderTop: "1ps solid" }}
