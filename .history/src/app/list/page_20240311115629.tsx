      ...
      <div className="  w-11/12 h-96 ">
        <div className="container mx-auto py-6 px-0 ">
          <div className="w-inherit">
            <div className="container w-full mx-auto py-6 px-0 flex flex-row justify-items-start gap-2 max-[380px]:flex-col">
              <div className="rounded-xl border-[1px] min-w-1/3 mb-2  px-3 flex  justify-center items-center">
                <SearchIcon />
                <InputBase
              ...
              <div className="rounded-xl min-w-1/6 mb-2 flex flex-row py-1 items-center">
                <SwapVertIcon />
                <Select
                  // value={editField.category}
