...
export default function PdfListPage() {
  ...
  const clearDateRangeFilter = () => {
    let clearDateStart = setStartDate(undefined)
    let claerDateEnd = setEndDate(undefined)
    filterPdfList(fileCategory, clearDateStart, claerDateEnd, searchQuery);
  };
