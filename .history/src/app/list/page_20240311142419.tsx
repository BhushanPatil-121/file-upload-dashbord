    ...
    <div className="flex flex-col items-center justify-between  min-w-full mt-14 ">
      ...
      <div className="  w-11/12 h-96 ">
        <div className="container mx-auto py-4 px-0 ">
          <div className="w-inherit flex justify-center align-top flex-col">
            <div className=" mx-auto pt-4 px-0 flex flex-row justify-items-start gap-2 max-[1010px]:flex-col ">
                ...
                <Popover>
                  <PopoverTrigger asChild>
                    <Button
                      ...
                      variant={"outline"}
                      className={cn(
                        " justify-start text-left font-normal w-180",
                        !date && "text-muted-foreground"
                      )}
                    >
                      <CalendarIcon className="mr-2 h-4 w-4" />
