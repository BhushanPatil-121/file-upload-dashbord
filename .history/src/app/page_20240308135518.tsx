...
export default function Home() {
  ...
  const handleSubmit = () => {
    clearField();
    if(fileName.length > 0 && category.length > 0) {
      console.log(fileName, fileSize, category, date);a
    }
  };
  const clearField = () => {
    setFile("");
              ...
              <form>
                <div className="grid w-full items-center gap-4">
                  <div className="flex flex-col space-y-3">
                    ...
                    />
                    {fileName.length < 1  &&
                     <p className="absolute mt-none px-4 text-xs text-red-500 font-semibold">This number is already exist!</p>
                   }
                  </div>
