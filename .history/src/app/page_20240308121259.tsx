      ...
      <Card className="flex flex-col items-center justify-center min-h-screen min-w-full">
        {file ? (
          ...
          <Card className="flex flex-col items-center justify-evenly border-hidden gap-10 shadow-none">
            ...
            <div className="bg-gray-50 text-center px-4 rounded w-90 flex flex-col items-center justify-center cursor-pointer border-2 border-gray-400 border-dashed mx-auto font-[sans-serif]">
              <div className="py-6">
                <svg
